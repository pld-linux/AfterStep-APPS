...
Czym jest fajny zarządca okien bez fajnych apletów? Cóż... jest nadal
fajnym zarządcą okien, ale aplety, które mogą być używane w module
Wharf AfterStepa lub Window Makera, mogłyby zwiększyć efektywność i
efektowność twojego ulubionego zarządcy okien.

Jeżeli masz zainstalowanego AfterStepa to powinieneś zainstalować
także ten pakiet. Miłej zabawy!
